...
export class StatusBar extends Component {
    ...
    onSwish = () => {
        ...
        // old string, just in case new one doesnt work
        //let canSwish = this.props.totalSum > 0 ? 'swish://payment?data=%7B%22version%22%3A1%2C%22payee%22%3A%7B%22value%22%3A%20%221236130983%22%7D%2C%22amount%22%3A%7B%22value%22%3A' + (this.props.totalSum + swishFee).toString() +'%7D%2C%22message%22%3A%7B%22value%22%3A%22skrubben.setIsGrateful%28true%29%22%7D%7D' : ''

        // new string
        let canSwish = this.props.totalSum > 0 ? 'swish://payment?data=%7B%22version%22%3A1%2C%22payee%22%3A%7B%22value%22%3A%20%221236130983%22%7D%2C%22amount%22%3A%7B%22value%22%3A' + (this.props.totalSum + swishFee).toString() +'%7D%2C%22message%22%3A%7B%22value%22%3A%22skrubben.setIsGrateful(true).OBS!%20A%202kr%20fee%20added%22%7D%7D' : ''
